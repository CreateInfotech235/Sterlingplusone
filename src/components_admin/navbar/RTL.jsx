        ...
        <Dropdown
          ...
          children={
            <div className="flex w-[350px] flex-col gap-2 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none">
              ...
              <Link
                target="blank"
                to="https://horizon-ui.com/pro?ref=live-free-tailwind-react"
              ...
              <Link
                target="blank"
                to="https://horizon-ui.com/docs-tailwind/docs/react/installation?ref=live-free-tailwind-react"
              ...
              <Link
                target="blank"
                to="https://horizon-ui.com/?ref=live-free-tailwind-react"
